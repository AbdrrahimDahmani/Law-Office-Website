        ...
        <div class="dash-content">
            <div class="activity">
                ...
                <?php
                    ...
                    ?>
                <form
                    action="https://localhost/lawyerProject/admin/pages/consultation/updateInfo.php?idcon=<?php echo $idcon; ?>&idcli=<?php echo $idcli; ?>"
                    ...
                    <input type="text" name="userName" id="name"
                        value="<?php echo $row['nomP'] . " " . $row['prenomP']; ?>" readonly />
                    ...
                    <div class="radio-grp">
                        ...
                        <input type="radio" id="done" name="status" value="1"
                            <?php if ($row['isDone'] != 0) echo "checked"; ?> />
                        <label for="done">Done</label>
                        <input type="radio" id="inpro" name="status" value="0"
                            <?php if ($row['isDone'] == 0) echo "checked"; ?> />
